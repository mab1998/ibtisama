...
@section('container')
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveDatabase') }}" class="tabs-wrap">
            ...
            <div class="form__data">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="Pro Task" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_username" id="database_username" autocomplete="one-time-code" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.db_username_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="password" name="database_password" id="database_password" autocomplete="one-time-code" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.db_password_placeholder') }}" />
                ...
                <input type="hidden" name="database_port" id="database_port" value="3306" placeholder="{{ trans('installer_messages.environment.wizard.form.db_port_placeholder') }}" />
            </div>

            <div class="buttons">
                <button class="button">
                    {{ trans('installer_messages.environment.database.button') }}
